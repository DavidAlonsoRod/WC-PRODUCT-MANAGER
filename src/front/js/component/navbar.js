			...
			<div className="container-fluid">
				...
				{store.auth || localStorage.getItem("token") ? (
					<div className="col-6 navbar-links d-flex align-items-center">
						...
						<Link to="/scanqr">
							<button className="btn" id="button">
								<svg className="m-2" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="20px" fill="#629a97"><path d="M480-80q-150 0-255-105T120-440q0-150 105-255t255-105q150 0 255 105t105 255q0 150-105 255T480-80Zm0-60q125 0 212.5-87.5T780-440q0-125-87.5-212.5T480-740q-125 0-212.5 87.5T180-440q0 125 87.5 212.5T480-140Zm-40-160h80v-80h-80v80Zm0-160h80v-240h-80v240Z" /></svg>
								Escanear QR
							</button>
						</Link>
						<Link to="/customers">
